...
struct Ast: dom::DomItem {
	...
	pin<Function> mk_fn(string name, pin<Action> result_type, std::initializer_list<pin<Type>> params);
	pin<Method> mk_method(Mut mut, pin<Class> cls, string m_name, pin<Action> result_type, std::initializer_list<pin<Type>> params);
