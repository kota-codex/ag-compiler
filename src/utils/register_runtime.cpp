...
void register_runtime_content(struct ast::Ast& ast) {
	...
	auto obj_equals = ast.mk_method(mut::ANY, ast.object, "equals", new ast::ConstBool, { ast.tp_conform_ref(ast.object) });
	...
	ast.mk_method(mut::MUTATING, ast.blob, "copy", new ast::ConstBool, { ast.tp_int64(), ast.tp_conform_ref(ast.blob), ast.tp_int64(), ast.tp_int64() });
	...
	});
	{
		...
		auto own_to_t = ast.tp_own(t_cls);
		...
		ast.mk_method(mut::MUTATING, ast.own_array, "spliceAt", new ast::ConstBool, { ast.tp_int64(), ast.tp_optional(ast.tp_ref(t_cls)) });
	}
	...
	});
	{
		...
		ast.mk_method(mut::MUTATING, ast.weak_array, "setAt", new ast::ConstVoid, { ast.tp_int64(), ast.tp_weak(t_cls) });
	}
	{
		...
		ast.mk_method(mut::MUTATING, shared_array_cls, "setAt", new ast::ConstVoid, { ast.tp_int64(), ast.tp_shared(t_cls) });
	}
	...
	ast.mk_overload(ast.string_cls, obj_equals);
	{
		...
		make_factory(ast.mk_method(mut::MUTATING, cursor_cls, "set", nullptr, { ast.tp_shared(ast.string_cls) }));
	}
	{
		...
		ast.mk_method(mut::MUTATING, map_cls, "delete", opt_ref_to_val_res, { ast.tp_shared(key_cls) });
		ast.mk_method(mut::ANY, map_cls, "getAt", opt_ref_to_val_res, { ast.tp_shared(key_cls) });
		ast.mk_method(mut::MUTATING, map_cls, "setAt", opt_ref_to_val_res, { ast.tp_shared(key_cls), ast.tp_own(val_cls) });
	...
	}
	{
		...
		ast.mk_method(mut::ANY, map_cls, "capacity", new ast::ConstInt64, {});
		ast.mk_method(mut::MUTATING, map_cls, "clear", new ast::ConstVoid, {});
		ast.mk_method(mut::MUTATING, map_cls, "delete", opt_shared_to_val_res, { ast.tp_shared(key_cls) });
		ast.mk_method(mut::ANY, map_cls, "getAt", opt_shared_to_val_res, { ast.tp_shared(key_cls) });
		ast.mk_method(mut::MUTATING, map_cls, "setAt", opt_shared_to_val_res, { ast.tp_shared(key_cls), ast.tp_shared(val_cls) });
		ast.mk_method(mut::ANY, map_cls, "keyAt", opt_shared_to_key_res, { ast.tp_int64() });
	...
	}
	{
		...
		ast.mk_method(mut::ANY, map_cls, "capacity", new ast::ConstInt64, {});
		ast.mk_method(mut::MUTATING, map_cls, "clear", new ast::ConstVoid, {});
		ast.mk_method(mut::MUTATING, map_cls, "delete", weak_to_val_res, { ast.tp_shared(key_cls) });
		ast.mk_method(mut::ANY, map_cls, "getAt", weak_to_val_res, { ast.tp_shared(key_cls) });
		ast.mk_method(mut::MUTATING, map_cls, "setAt", weak_to_val_res, { ast.tp_shared(key_cls), ast.tp_weak(val_cls) });
		ast.mk_method(mut::ANY, map_cls, "keyAt", opt_shared_to_key_res, { ast.tp_int64() });
		ast.mk_method(mut::ANY, map_cls, "valAt", weak_to_val_res, { ast.tp_int64() });
	}
	ast.mk_fn("getParent", opt_ref_to_object, { ast.tp_ref(ast.object) });
	ast.mk_fn("log", new ast::ConstVoid, { ast.tp_conform_ref(ast.string_cls) });
	ast.mk_fn("hash", new ast::ConstInt64, { ast.tp_shared(ast.object) });
	ast.mk_fn("nowMs", new ast::ConstInt64, {});
	ast.mk_fn("terminate", new ast::Break, { ast.tp_int64() });
	ast.mk_fn("setMainObject", new ast::ConstVoid, { ast.tp_optional(ast.tp_ref(ast.object))});
	ast.mk_fn("weakExists", new ast::ConstBool, { ast.tp_weak(ast.object) });
	...
	});
	{
		...
		auto start = ast.mk_method(mut::MUTATING, thread, "start", nullptr, { ast.tp_ref(param) });
		make_factory(start);
